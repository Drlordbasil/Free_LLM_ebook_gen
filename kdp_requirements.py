...
class Generate_kdp_details:
    def __init__(self, chapter, book_title, book_id, all_book_folder):
    ...
    def generate(self):
        ...
        kdp_details = local_LLM_api.mistral_chat(system="""
                                                ...
                                                suggest a fair market price in USD, create a Short Description with high keyword density for SEO purposes, 
                                                 ...
                                                 """, user=f"""
        {kdp_details_text_format}I have a text snippet from an ebook that includes the title and the first chapter. 
...
""")
    ...
    def save_details_to_book_folder(self):
        try:
            ...
            print(f"KDP details saved as {details_path}")
            return details_path
